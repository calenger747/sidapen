...
class Home_lurah extends CI_Controller
{
    ...
    function data_penduduk(){
        ...
        $this->load->view('v_lurah_data_penduduk', $data);
    }
    ...
    function data_penduduk_sementara(){
        ...
        $this->load->view('v_lurah_lihat_penduduk_sementara', $data);
    }
    ...
    function data_kk(){
        ...
        $this->load->view('v_lurah_kk', $data);
    }
    ...
    function lihat_detail(){
        ...
        $this->load->view('v_lurah_lihat_detail', $data);
    }
	...
	function lihat_detail1(){
        ...
        $this->load->view('v_lurah_lihat_detail1', $data);
    }
	
	function lihat_detail2(){
        $user_id = $this->uri->segment(3);
        $data['title'] = 'Detail Penduduk &minus; SIDAPEN';
        $data['nama'] = $this->session->userdata('user_nama');
        $data['detail'] = $this->m_sidapen->lihat_detail_penduduk1($user_id);
        $this->load->view('v_lurah_lihat_detail2', $data);
    }
    ...
    function lihat_detail_kk(){
        ...
        $this->load->view('v_lurah_lihat_detail_kk', $data);
    }
    ...
    function cari_rtrw(){
        ...
        $this->load->view('v_lurah_hasil_pencarian', $data);
    }
    ...
    function profil(){
        ...
        $this->load->view('v_lurah_profil', $data);
    }
    ...
    function ubah_password(){
        ...
        $this->load->view('v_lurah_ubah_password', $data);
    }
    ...
    function update_password(){
        ...
        if(!$update){
            ...
            redirect('home_lurah/ubah_password');
        }else{
	...
	function cetak_data_penduduk_sementara(){
		...
		$penduduk = $this->m_sidapen->data_penduduk_sementara()->result();
       ...
       $this->fpdf->SetFont('Arial', 'B', 10);
        ...
        $this->fpdf->Output('DAFTAR_DATA_PENDUDUK_SEMENTARA', 'I');
    }
	...
	function cetak_data_penduduk(){
        ...
        $rt = $data['rt'];
        $rw = $data['rw'];
		$penduduk = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah()->result();
	...
	function cetak_data_kk(){
	 ...
	 function cetak_data_statistik_lurah(){
        $this->load->library('fpdf');
       ...
       $penduduk = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah()->result();
		$penduduk_laki = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_laki()->result();
		$penduduk_wanita = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_perempuan()->result();
		$total_sementara = $this->m_sidapen->data_penduduk_sementara()->num_rows();
        $jumlah_kk = $this->m_sidapen->jumlah_kk()->num_rows();
        $total_kawin = $this->m_sidapen->total_kawin3()->num_rows();
        $total_belum_kawin = $this->m_sidapen->total_belum_kawin3()->num_rows();
        $total_pria = $this->m_sidapen->total_pria3()->num_rows();
        $total_wanita = $this->m_sidapen->total_wanita3()->num_rows();
		$jumlah3 = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah()->result();
		$jumlah6 = $this->m_sidapen->jumlah_penduduk_kawin_lurah()->result();
		$jumlah7 = $this->m_sidapen->jumlah_penduduk_belumkawin_lurah()->result();
		...
		$jumlah5 = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_laki()->result();
		...
		$jumlah4 = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_perempuan()->result();						
        ...
        $this->fpdf->Ln();
        $this->fpdf->Cell('', .3, 'Kelurahan ', 0, 0, 'C');
        $this->fpdf->Ln();
        $this->fpdf->Ln();
        $this->fpdf->Ln();
	...
	function export_datakk(){
        ...
        array_to_csv($data, 'data_kepala Keluarga_Kelurahan'.'.csv');
    }
	...
	function export_datapenduduk(){
        ...
        $this->load->helper('csv');
        array_to_csv($data, 'data_penduduk_Kelurahan'.'.csv');
    }
	...
	function export_datapenduduk_sementara(){
        ...
        $this->load->helper('csv');
        array_to_csv($data, 'data_penduduk_sementara_kelurahan'.'.csv');
    }
	
	function export_datastatistik_lurah(){
        $data['rt'] = $this->session->userdata('rt');
        $data['rw'] = $this->session->userdata('rw');
        $rt = $data['rt'];
        $rw = $data['rw'];
...
$data[++$i] = array('');
        ...
        $this->load->helper('csv');
        array_to_csv($data, 'data_statistik_Kelurahan'.'.csv');
    }
    ...
    function grafik_penduduk(){
        ...
        $this->load->view('v_lurah_grafik_penduduk', $data);
    }
	...
	function grafik_penduduk1(){
        ...
        $this->load->view('v_lurah_grafik_penduduk1', $data);
    }
	
	function grafik_penduduk2(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        ...
        $data['jml_rw'] = $this->m_sidapen->jumlah_rw()->num_rows();
        $data['jumlah_kk'] = $this->m_sidapen->jumlah_kk()->num_rows();
		$data['jumlah1'] = $this->m_sidapen->total_pria3()->num_rows();
		$data['jumlah2'] = $this->m_sidapen->total_wanita3()->num_rows();
		$data['jumlah3'] = $this->m_sidapen->total_kawin3()->num_rows();
		$data['jumlah4'] = $this->m_sidapen->total_belum_kawin3()->num_rows();
		$data['jumlah5'] = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah()->result();
		$data['jumlah6'] = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_perempuan()->result();
		$data['jumlah7'] = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_laki()->result();
		$data['jumlah8'] = $this->m_sidapen->total_kawin_pria_lurah()->result();
		$data['jumlah9'] = $this->m_sidapen->total_kawin_wanita_lurah()->result();
		$data['jumlah10'] = $this->m_sidapen->total_belum_kawin_pria_lurah()->result();
		$data['jumlah11'] = $this->m_sidapen->total_belum_kawin_wanita_lurah()->result();

        $this->load->view('v_lurah_grafik_penduduk2', $data);
    }
	 ...
	 function data_statistik(){
		...
		$data['jumlah3'] = $this->m_sidapen->total_kawin3()->num_rows();
		$data['jumlah4'] = $this->m_sidapen->total_belum_kawin3()->num_rows();
		$data['jumlah5'] = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_perempuan()->result();
		$data['jumlah6'] = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah_laki()->result();
		$data['jumlah7'] = $this->m_sidapen->data_penduduk_pemilu_imunisasi_lurah()->result();
		$data['jumlah8'] = $this->m_sidapen->jumlah_penduduk_kawin_lurah()->result();
		$data['jumlah9'] = $this->m_sidapen->jumlah_penduduk_belumkawin_lurah()->result();
		$data['penduduk'] = $this->m_sidapen->penduduk_lurah_rt()->result();
		$data['penduduk1'] = $this->m_sidapen->penduduk_lurah_rw()->result();
		$data['total_sd'] = $this->m_sidapen->data_penduduk_SD_lurah()->num_rows();
		$data['total_smp'] = $this->m_sidapen->data_penduduk_SMP_lurah()->num_rows();
		$data['total_sma'] = $this->m_sidapen->data_penduduk_SMA_lurah()->num_rows();
		$data['total_d3'] = $this->m_sidapen->data_penduduk_D3_lurah()->num_rows();
		$data['total_s1'] = $this->m_sidapen->data_penduduk_S1_lurah()->num_rows();
		$data['total_s2'] = $this->m_sidapen->data_penduduk_S2_lurah()->num_rows();
		$data['total_s3'] = $this->m_sidapen->data_penduduk_S3_lurah()->num_rows();
		$data['jumlah10'] = $this->m_sidapen->total_kawin_pria_lurah()->result();
		$data['jumlah11'] = $this->m_sidapen->total_kawin_wanita_lurah()->result();
		$data['jumlah12'] = $this->m_sidapen->total_belum_kawin_pria_lurah()->result();
		$data['jumlah13'] = $this->m_sidapen->total_belum_kawin_wanita_lurah()->result();

        $this->load->view('v_lurah_statistik', $data);
    }
	...
	function data_statistik1(){
        ...
        $data['jml_rt'] = $this->m_sidapen->jumlah_rt()->num_rows();
        $data['jml_lurah'] = $this->m_sidapen->jumlah_lurah()->num_rows();
        $data['jml_rt1'] = $this->m_sidapen->total_rt1($rw)->num_rows();
		$data['jumlah'] = $this->m_sidapen->jumlah_penduduk_rw($rw)->num_rows();
		$data['total_sementara'] = $this->m_sidapen->data_penduduk_rw_sementara($rw)->num_rows();
        $data['jumlah_kk'] = $this->m_sidapen->jumlah_kk_rt2($rw)->num_rows();
        $data['total_kawin1'] = $this->m_sidapen->total_kawin1($rw)->num_rows();
		...
		$data['penduduk2'] = $this->m_sidapen->penduduk_lurah_rw1($rw)->result();
        ...
        $this->load->view('v_lurah_statistik1', $data);
    }
	...
	function data_statistik2(){
        ...
        $this->load->view('v_lurah_statistik2', $data);
    }
	
	function data_statistik_total(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        $rw = $this->uri->segment(3);
        $data['rt'] = $rt;
        ...
        $this->load->view('v_lurah_statistik_total', $data);
    }
	
	function data_statistik_total1(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        $rw = $this->uri->segment(3);
        $data['rt'] = $rt;
        ...
        $this->load->view('v_lurah_statistik_total1', $data);
    }
	
	function data_statistik_total2(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        $rw = $this->uri->segment(3);
        $data['rt'] = $rt;
        ...
        $this->load->view('v_lurah_statistik_total2', $data);
    }
	
	function data_statistik_total3(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        $rw = $this->uri->segment(3);
        $data['rt'] = $rt;
        ...
        $this->load->view('v_lurah_statistik_total3', $data);
    }
	
	function data_statistik_total4(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        $rw = $this->uri->segment(3);
        $data['rt'] = $rt;
        ...
        $this->load->view('v_lurah_statistik_total4', $data);
    }
	
	function data_statistik_total5(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        $rw = $this->uri->segment(3);
        $data['rt'] = $rt;
        ...
        $this->load->view('v_lurah_statistik_total5', $data);
    }
	
	function data_statistik_total6(){
       $data['title'] = 'Grafik Penduduk &minus; SIDAPEN';
        $rt = '';
        $rw = $this->uri->segment(3);
        $data['rt'] = $rt;
        ...
        $this->load->view('v_lurah_statistik_total6', $data);
    }
	...
	function data_statistik_kesehatan(){
       $data['title'] = 'Data Statistik &minus; SIDAPEN';
        ...
        $this->load->view('v_lurah_statistik_kesehatan', $data);
    }
	...
	function data_statistik_pemkel(){
       $data['title'] = 'Data Statistik &minus; SIDAPEN';
        ...
        $this->load->view('v_lurah_statistik_pemkel', $data);
    }
	...
	function data_statistik_pendidikan(){
       $data['title'] = 'Data Statistik &minus; SIDAPEN';
        ...
        $this->load->view('v_lurah_statistik_pendidikan', $data);
    }
	...
	function data_statistik_peribadatan(){
       $data['title'] = 'Data Statistik &minus; SIDAPEN';
        ...
        $this->load->view('v_lurah_statistik_peribadatan', $data);
    }
	...
	function data_statistik_perekonomian(){
       $data['title'] = 'Data Statistik &minus; SIDAPEN';
        ...
        $this->load->view('v_lurah_statistik_perekonomian', $data);
    }
	...
	function data_statistik_olahraga(){
       $data['title'] = 'Data Statistik &minus; SIDAPEN';
        ...
        $this->load->view('v_lurah_statistik_olahraga', $data);
    }
