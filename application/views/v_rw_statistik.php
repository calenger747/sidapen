        ...
        <div class="col-md-9">
		 <div class="panel panel-warning">
              <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;Data Ketua RT <strong>| RW <?php echo $rw;?></strong></h3>
              </div>
              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                  <span class="pull-left">
                    <span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;Data Statistik Penduduk <strong>| RW <?php echo $rw;?></strong>
                  </span>

                  <span class="pull-right">
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rw/cetak_data_statistik_rw" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak PDF</a>
					<a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rw/export_datastatistik_rw" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Excel</a>
                  </span>
                </div>
              </div>
                      ...
                      <div class="panel panel-default">
                        <ul class="list-group">
                          <li class="list-group-item">
                            ...
                            <h4><b>Jumlah Penduduk Keseluruhan | RW <?php echo $rw;?>
							&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $jumlah;?>&nbsp;&nbsp;Orang</b></h4>
							<p>
                          ...
                          <thead>
                            <tr>
							 ...
							 <tr>
								<td align = "center" valign = "middle"><?php echo $total_sementara;?></td>
								<td align = "center" valign = "middle"><?php echo $jumlah_kk;?></td>
								<td align = "center" valign = "middle"><?php echo $total_pria1;?></td>
								<td align = "center" valign = "middle"><?php echo $total_wanita1;?></td>
								<td align = "center" valign = "middle"><?php echo $total_kawin1;?></td>
								<td align = "center" valign = "middle"><?php echo $total_belum_kawin1;?></td>
						  ...
						  <h4><b>Berdasarkan Jenis Kelamin</b></h4>
                            <span class="badge"><?php echo $total_pria1;?></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;- Pria
						<p>
							 <table class='table table-striped table-hover'>
                          <thead>
                          ...
                          <li class="list-group-item">
                            <span class="badge"><?php echo $total_wanita1;?></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;- Wanita
							 <table class='table table-striped table-hover'>
                          <thead>
                            <tr>
						  ...
						  <h4><b>Berdasarkan Jenis Kelamin</b></h4>
						   <table class='table table-striped table-hover'>
                             <tr>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_pria1;?></span>&nbsp;&nbsp;Orang</div></td>
							</tr>
							<tr>
								<td align = "left" valign = "middle" width="80"></td>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_wanita1;?></span>&nbsp;&nbsp;Orang</div></td>
							</tr>
							<tr>
								<td align = "left" valign = "middle" width="80"></td>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $jumlah;?></span>&nbsp;&nbsp;Orang</div></td>
							</tr>
						</table>
						</li>
						  <!--<li class="list-group-item">
						  <h4><b>Status Perkawinan</b></h4>
                            <span class="badge"><?php echo $total_kawin1;?></span>
                            &nbsp;&nbsp;&nbsp;&nbsp;- Kawin
							<p>
							 <table class='table table-striped table-hover'>
                          <thead>
                          ...
                          <li class="list-group-item">
                            <span class="badge"><?php echo $total_belum_kawin1;?></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;- Belum Kawin
							 <p>
							 <table class='table table-striped table-hover'>
                          <thead>
						  ...
						  <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Kawin : </b></div>
						   <li class="list-group-item">
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_kawin1;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
						  ...
						  <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Kawin : </b></div>
						   <li class="list-group-item">
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="300"><b>- Total Kawin :</b></td>
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle"><span class="badge"><?php echo $total_kawin1;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
						   ...
						   <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Belum Kawin : </b></div>
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle"><span class="badge"><?php echo $total_belum_kawin1;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
                           </li>
							 </li>-->
						   ...
						   <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Belum Kawin : </b></div>
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_belum_kawin1;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
                           </li>
							 </li>
