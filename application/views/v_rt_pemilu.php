              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                  ...
                  <span class="pull-right">
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rt/cetak_data_pemilu/<?php echo $tgl_pemilu ;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak PDF</a>

                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rt/export/<?php echo $tgl_pemilu ;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Excel</a>
                  </span>
                </div>
              </div>
