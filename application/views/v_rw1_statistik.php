              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                  ...
                  <!--<span class="pull-right">
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rw/cetak_data_statistik_rt" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak PDF</a>
					<a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rw/export_datastatistik_rt/<?php echo $rt;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Data Excel</a>
                  </span>-->
                </div>
              </div>
