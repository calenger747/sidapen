...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Grafik Sarana Peribadatan'
        },
        subtitle: {
            text: 'Kelurahan'
        },
        ...
        series: [{
            ...
            data: [
				<?php
								 ...
								 $total3= 0;
								 $total4= 0;
								$ambildata = mysql_query("select * from sarana_peribadatan WHERE rw='05' ");
...
$(function () {
    $('#container1').highcharts({
        ...
        title: {
            text: 'Diagram Sarana Peribadatan'
        },
        subtitle: {
        ...
        series: [{
			...
			<?php
				...
				['Masjid', <?php echo number_format((($total/$total5)*100),2);?>], 
			    ['Mushollah', <?php echo number_format((($total1/$total5)*100),2);?>],
				['Gereja', <?php echo number_format((($total2/$total5)*100),2);?>], 
			    ['Vihara', <?php echo number_format((($total3/$total5)*100),2);?>],
			    ['Pure', <?php echo number_format((($total4/$total5)*100),2);?>]
