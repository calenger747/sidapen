...
//Script Upload File..
    ...
    while (($data = fgetcsv($handle, 0, ",")) !== FALSE) {
        $import="INSERT into sarana_pemerintah (id_pemerintah,kantor_lurah,balai_pertemuan,pos_rw,rt,rw) 
    ...
    echo "<br><strong>Import data selesai.</strong>";
                      ...
                      <h3><font face='arial'>Silahkan masukan file csv Sarana Pemerintah Kelurahan<br /></h3>
					  <hr>
						<form enctype='multipart/form-data' action='' method='post'>
							<h4>bentuk format penulisan excel dan di simpan dalam bentuk csv.</h4>
							<img src="<?php echo base_url();?>berkas/img/pemerintah.png" width ="50%" height="50%"></img>
