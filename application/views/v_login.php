...
<div class="container" style="margin-top: 2%">
    ...
    <div class="col-md-6" style="background:rgba(0,0,0,.8);border-radius:5px">
    	...
    	<div >
	<a href="http://lrcom.co.id/pelayanan/"><img src="<?php echo base_url();?>berkas/img/pelayanan.png" width="200px" class="pull-right"></a><p>
    ...
    <div class="col-md-3">
    	...
    	<div >
	<a href="#"><img src="<?php echo base_url();?>berkas/img/sarana.png" width="200px" class="pull-right"></a><p>
