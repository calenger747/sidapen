              ...
              <div class="panel-heading">
                <h3 class="panel-title"><span class='glyphicon glyphicon-edit'></span>&nbsp;&nbsp;Edit Data</h3>
                  ...
                  <div class="panel-body">
                    <form name="form" action="<?php echo base_url();?>admin/update_penduduk" method="post">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input name="rt" class="form-control input-sm" type="text" maxlength="3" value="<?php echo $rt;?>" required>
