        ...
        ?>
            ...
            <div class="panel panel-warning">
              <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Tambah User &raquo; RT</h3>
              </div>
                  <div class="panel-body">
                    <form action="<?php echo base_url();?>admin/add_rt" method="post">
                      <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input name="rt" class="form-control input-sm" type="text" minlength="2" maxlength="2" required>
