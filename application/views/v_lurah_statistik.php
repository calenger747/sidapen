              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                  <span class="pull-left">
                    <span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;Data Statistik Kelurahan
                  </span>

                  <span class="pull-right">
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_lurah/cetak_data_statistik_lurah/<?php echo $jml;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak PDF</a>
					<a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_lurah/export_datastatistik_lurah/<?php echo $jml ;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Excel</a>
                  </span>
                </div>
              </div>
                      ...
                      <div class="panel panel-default">
                        <ul class="list-group">
                          <li class="list-group-item">
                            ...
                            <h4><b>Jumlah Penduduk Kelurahan <?php echo $rw;?>
							&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $jml;?>&nbsp;&nbsp;Orang</b></h4>
							<p>
                          ...
                          <thead>
                            <tr>
							 ...
							 <tr>
								<td align = "center" valign = "middle"><?php echo $jml_sementara;?></td>
								<td align = "center" valign = "middle"><?php echo $jumlah_kk;?></td>
								<td align = "center" valign = "middle"><?php echo $jumlah1;?></td>
								<td align = "center" valign = "middle"><?php echo $jumlah2;?></td>
								<td align = "center" valign = "middle"><?php echo $jumlah3;?></td>
								<td align = "center" valign = "middle"><?php echo $jumlah4;?></td>
								<td align = "center" valign = "middle">
								<?php 
									$data = array();
									foreach($jumlah7 as $j){
						  ...
						  <h4><b>Berdasarkan Jenis Kelamin</b></h4>
						   <table class='table table-striped table-hover'>
                             <tr>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $jumlah1;?></span>&nbsp;&nbsp;Orang</div></td>
							</tr>
							<tr>
								<td align = "left" valign = "middle" width="80"></td>
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $jml;?></span>&nbsp;&nbsp;Orang</div></td>
							</tr>
						</table>
						</li>
						  ...
						  <li class="list-group-item">
                              <!--<h4><b>Berdasarkan Jenis Kelamin</b></h4>-->
                            <span class="badge"><?php echo $jumlah1;?></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;- Pria
						<p>
							 <table class='table table-striped table-hover'>
                          <thead>
						...
						<p>
						  ...
						  <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Kawin : </b></div>
						   <li class="list-group-item">
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle"><span class="badge"><?php echo $jumlah3;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
						  ...
						  <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Kawin : </b></div>
						   <li class="list-group-item">
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $jumlah3;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
						   ...
						   <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Belum Kawin : </b></div>
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $jumlah4;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
                           </li>
							 </li>
						   ...
						   <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Belum Kawin : </b></div>
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="300"><b>- Total Belum Kawin :</b></td>
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle"><span class="badge"><?php echo $jumlah4;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
                           </li>
							 </li>-->
						 ...
						 <h4><b>Status Perkawinan</b></h4>
						  ...
						  <li class="list-group-item">
                            <span class="badge"><?php echo $jumlah4;?></span>
                             &nbsp;&nbsp;&nbsp;&nbsp;- Belum Kawin
							 <p>
							 <table class='table table-striped table-hover'>
                          <thead>
                          ...
                          <li class="list-group-item">
						   ...
						   <li class="list-group-item">
                            <span class="badge"><?php echo $jml_rw;?></span>
                             <b>Jumlah RW </b>
                          </li>
                          <li class="list-group-item">
