              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                 ...
                 <!-- <span class="pull-right">
					...
					<a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_lurah/export_datastatistik_rw/<?php echo $rw;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Excel</a>
                  </span>-->
                </div>
              </div>
                      ...
                      <div class="panel panel-default">
						...
						<p>
						 ...
						 <li class="list-group-item">
                          ...
                          <li class="list-group-item">
                            <span class="badge"><?php echo $jml_rt1;?></span>
                            <b>Jumlah RT</b>
                          </li>
                          <li class="list-group-item">
