              ...
              <div class="panel-heading">
                <h3 class="panel-title"><span class='glyphicon glyphicon-edit'></span>&nbsp;&nbsp;Edit Data</h3>
                  ...
                  <div class="panel-body">
                    <form name="form" action="<?php echo base_url();?>admin/update_kk" method="post">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input name="rw" class="form-control input-sm" type="text" maxlength="3" value="<?php echo $rw;?>" required>
                            ...
                            <div class="col-md-3">
                                <input name="rt" class="form-control input-sm" type="text" minlength="3" maxlength="3" value="<?php echo $rt;?>" required>
                                 <p class="text-muted"><em>Format: 000, Contoh: 005, 020</em></p>
                            </div>
                        </div>
