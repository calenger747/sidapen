        ...
        ?>
            ...
            <div class="panel panel-warning">
              <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-wrench"></span>&nbsp;&nbsp;Ubah Profil</h3>
              </div>
                  <div class="panel-body">
                  <form action="<?php echo base_url();?>home_rw/update_password" method="post">
                    <div class="row">
                            <div class="col-md-3">
                                <label>Nama</label>
                            </div>
...
<a onclick="window.location='<?php echo base_url();?>home_rw'" class="btn btn-primary navbar-fixed-bottom"><span class="glyphicon glyphicon-chevron-left"></span>&nbsp;&nbsp;kembali ke halaman sebelumnya</a>
</body>