              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                  <span class="pull-left">
                    <span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;Data Statistik | <strong>RT <?php echo $rt ;?> RW <?php echo $rw;?></strong>
                  </span>

                  <span class="pull-right">
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rt/cetak_data_statistik_rt/<?php echo $jml;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak PDF</a>
					 <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rt/export_datastatistik_rt/" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Excel</a>
                  </span>
                </div>
              </div>
			  ...
			  <div class="panel-body">
                      <div class="panel panel-default">
						...
						<li class="list-group-item">
                          ...
                          <thead>
                            <tr>
							 ...
							 <tr>
								...
								<td align = "center" valign = "middle"><?php echo $total_pria;?></td>
								<td align = "center" valign = "middle"><?php echo $total_wanita;?></td>
								<td align = "center" valign = "middle"><?php echo $total_kawin;?></td>
								<td align = "center" valign = "middle"><?php echo $total_belum_kawin;?></td>
						  ...
						  <h4><b>Berdasarkan Jenis Kelamin</b></h4>
						   <table class='table table-striped table-hover'>
                             <tr>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_pria;?></span>&nbsp;&nbsp;Orang</div></td>
							</tr>
							<tr>
								<td align = "left" valign = "middle" width="80"></td>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_wanita;?></span>&nbsp;&nbsp;Orang</div></td>
							</tr>
							<tr>
								<td align = "left" valign = "middle" width="80"></td>
						  ...
						  <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Kawin : </b></div>
						   <li class="list-group-item">
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_kawin;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
                          ...
                          <li class="list-group-item">
						   <div align = "left">&nbsp;&nbsp;&nbsp;&nbsp;<b>- Belum Kawin : </b></div>
							...
							<tr>
								...
								<td align = "left" valign = "middle" width="80"></td>
								<td align = "left" valign = "middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $total_belum_kawin;?></span>&nbsp;&nbsp;Orang</td>
							</tr>
							</table>
                           </li>
							 </li>
						  ...
						  <li class="list-group-item">
                            <span class="badge"><?php echo $total_sementara;?></span>
