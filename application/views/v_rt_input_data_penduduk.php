...
<div style="margin-top: 80px;">
        ...
        <button class="btn btn-info pull-right" onclick="window.location='<?php echo base_url();?>home_rt'">&larr; kembali ke halaman utama</button>
              ...
              <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;Input Data</h3>
                  ...
                  <div class="panel-body">
                    ...
                    <form name="form" action="<?php echo base_url();?>home_rt/data_input" method="post">
                        <div class="row">
                            <div class="col-md-2">
                                <label>Nama </label>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input name="kk_rw" class="form-control input-sm" type="text" maxlength="3" value="<?php echo $rw;?>" readonly>
                            ...
                            <div class="col-md-4">
                                <input name="kk_rt" class="form-control input-sm" type="text" minlength="3" maxlength="3" value="<?php echo $rt;?>" readonly>
                                 <p class="text-muted"><em>Format: 00, Contoh: 05, 20</em></p>
                            </div>
                         </div>
                        ...
                        <tr>
                          <p>
                            ...
                            <td>
                                ...
                                <input type="hidden" value="<?php echo $rt;?>" name="rt[]">
                                <input type="hidden" value="<?php echo $rw;?>" name="rw[]">
                            </td>
                            </p>
                        </tr>
                        </tbody>
