...
<div class="container" align="center">
    <button class="btn btn-sm btn-info" onclick="window.location='<?php echo base_url();?>home_rw'">&larr; kembali ke halaman sebelumnya</button><p>
