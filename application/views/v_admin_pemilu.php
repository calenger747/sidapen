              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                  <span class="pull-left">
                    <span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;Data Pemilu
                  </span>

                  <span class="pull-right">
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>admin/cetak_data_pemilu/<?php echo $tgl_pemilu ;?>/<?php echo $rt;?>/<?php echo $rw;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak PDF</a>

                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>admin/export/<?php echo $tgl_pemilu ;?>/<?php echo $rt;?>/<?php echo $rw;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Excel</a>
                  </span>
                </div>
              </div>
                ...
                <?php
                      ...
                      else
                      {
                        ...
                        foreach($penduduk as $pend){
                          $usia = date_diff(date_create($tgl_pemilu), date_create($pend->tgl_lahir));
                          if(($pend->status_pernikahan == 'K') OR ($usia->format('%Y tahun') >= '17 tahun')){
                          echo 
                          "<tr>"
                          .
                              "<td>".$pend->nama."</td>".
