                  ...
                  <div class="panel-body">
                      ...
                      else
                      {
					    ...
					    echo 
						  "<tr>"
                          .
						    "<td>"."Sarana Peribadatan"."</td>".
							"<td>&nbsp;"."&nbsp;"."</td>".
							"<td>
                                <a href='edit_sarana_peribadatan/".$pend->id_peribadatan."' class='btn btn-warning btn-sm' onclick='return confirm(\"Edit Sarana Peribadatan?\")'><span class='glyphicon glyphicon-edit'></span></a>
