...
<div style="margin-top: 80px;">
              ...
              <div class="panel-heading">
                <div class="panel-title clearfix">
                  ...
                  <span class="pull-right">
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rt/cetak_data_imunisasi/<?php echo $tgl_imunisasi;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak PDF</a>

                    <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>home_rt/export2/<?php echo $tgl_imunisasi ;?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Cetak Excel</a>
                  </span>
                </div>
              </div>
        ...
        <!-- END HOME  <th>Hub. Keluarga</th>  "<td>".$pend->status_dalam_keluarga."</td>".-->
