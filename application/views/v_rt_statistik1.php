                      ...
                      else
                      {
					    ...
					    echo 
                          ...
                          .
							...
							"<td>&nbsp;"."&nbsp;"."</td>".
							"<td>
                                <a href='edit_sarana/".$pend->id_kesehatan."' class='btn btn-warning btn-sm' onclick='return confirm(\"Edit Sarana Kesehatan?\")'><span class='glyphicon glyphicon-edit'></span></a>
