        ...
        series: [{
            ...
            data: [
			 <?php
								 ...
								 $total3= 0;
								 $total4= 0;
								$ambildata = mysql_query("select * from sarana_olahraga WHERE rw='05' ");
        ...
        series: [{
            ...
            data: [
			 <?php
								 ...
								 $total3= 0;
								 $total4= 0;
								$ambildata = mysql_query("select * from sarana_olahraga ");
				...
				['Lapangan Bola', <?php echo number_format((($total/$total5)*100),2);?>], 
			    ['Lapangan Basket', <?php echo number_format((($total1/$total5)*100),2);?>],
				['Lapangan Badminton', <?php echo number_format((($total2/$total5)*100),2);?>], 
			    ['Lapangan Volly', <?php echo number_format((($total3/$total5)*100),2);?>],
			    ['Lapangan Futsal', <?php echo number_format((($total4/$total5)*100),2);?>]
                  ...
                  <div class="panel-body">
					  ...
					  <?php
					   ...
					   <li class="list-group-item">
					    <h4><b>Total Sarana Olahraga </b></h4>
						   <table class='table table-striped table-hover'>
                             <tr>
								...
								<td rowspan ="5"><div id="container1" style="min-width: 180px; height: 230px; margin: 0 auto"></div></td>
							</tr>
							<tr>
