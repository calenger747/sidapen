        ...
        ?>
            ...
            <div class="panel panel-warning">
              <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Edit User &raquo; RW</h3>
              </div>
                  <div class="panel-body">
                    <form action="<?php echo base_url();?>admin/update_rw" method="post">
                      <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <input name="user_nama" class="form-control input-sm" type="text" minlength="5" value="<?php echo $edit_rw->user_nama;?>" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select name="rw" class="form-control input-sm" required>
                                    <option value="<?php echo $edit_rw->rw;?>"><?php echo $edit_rw->rw;?></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="user_name" value="<?php echo $edit_rw->user_name;?>" class="form-control input-sm" type="text" minlength="5" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="user_password" value="<?php echo $edit_rw->user_password;?>" class="form-control input-sm" type="password" minlength="7" required>
                                <p class="text-muted"><em>Isi password, minimal 7 karakter</em></p>
                            </div>
                        </div>

                        <input type="hidden" name="user_role" value="4" />
                        <input type="hidden" name="user_id" value="<?php echo $edit_rw->user_id;?>" />
