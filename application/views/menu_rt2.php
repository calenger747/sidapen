            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body panell">
                <div class="list-group">
				  ...
				  <a href="<?php echo base_url();?>home_rt/data_statistik_pemkel" class="list-group-item">
                    <span class="glyphicon glyphicon-stats"></span>&nbsp;&nbsp;pemerintahan Kelurahan
                  </a>
				  <a href="<?php echo base_url();?>home_rt/data_statistik_pendidikan" class="list-group-item">
                    <span class="glyphicon glyphicon-stats"></span>&nbsp;&nbsp;Pendidikan
                  </a>
				  <a href="<?php echo base_url();?>home_rt/data_statistik_peribadatan" class="list-group-item">
                    <span class="glyphicon glyphicon-stats"></span>&nbsp;&nbsp;Peribadatan
                  </a>
				  <a href="<?php echo base_url();?>home_rt/data_statistik_perekonomian" class="list-group-item">
                    <span class="glyphicon glyphicon-stats"></span>&nbsp;&nbsp;Perekonomian
                  </a>
				  <a href="<?php echo base_url();?>home_rt/data_statistik_olahraga" class="list-group-item">
                    <span class="glyphicon glyphicon-stats"></span>&nbsp;&nbsp;Fasilitas Olahraga
                  </a>
				  <a href="<?php echo base_url();?>home_rt/data_statistik_sosial" class="list-group-item">
